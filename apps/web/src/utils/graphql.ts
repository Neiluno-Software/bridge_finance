...
export const v3Clients = {
  ...
  [ChainId.ORB3]: new GraphQLClient(V3_SUBGRAPH_URLS[ChainId.ORB3]),
}
...
export const v2Clients = {
  ...
  [ChainId.ORB3]: new GraphQLClient(INFO_CLIENT_WITH_CHAIN[ChainId.ORB3]),
}
