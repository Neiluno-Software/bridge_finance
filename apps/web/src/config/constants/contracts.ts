...
export default {
  ...
  multiCall: {
    ...
    [ChainId.ORB3]: '0x6D984d78cE3dE3C5F4418679Fb26fd4934913042',
  },
  pancakeProfile: {
  ...
  chainlinkOracleETH: {
    ...
    [ChainId.GOERLI]: '0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e',
  },
  chainlinkOracleCAKE: {
  ...
  nftMarket: {
    ...
    [ChainId.ORB3]: '0x25BD5df9E70bbf509089492963F55De1c9D73d17',
  },
  nftSale: {
  ...
  nftPositionManager: {
    ...
    [ChainId.ORB3]: '0x2C30F01F3d6d3A2DF14593C2C878E7435FD6Ba95',
  },
  ...
  v3Migrator: {
    ...
    [ChainId.ORB3]: '0x47c02AA9F61CB547A5AA3F6fFB72E4409B3C90Fb',
  },
