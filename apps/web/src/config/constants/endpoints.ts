...
export const API_NFT = 'https://orb3-nft-api.vercel.app/api/v1'
// export const API_NFT = 'http://localhost:3003/api/v1'
export const GRAPH_API_NFTMARKET = 'https://subgraph.orb3.tech/subgraphs/name/orb3/nft-market'
...
export const BLOCKS_CLIENT_ORB3 = 'https://subgraph.orb3.tech/subgraphs/name/flack/blocks'
...
export const INFO_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.ORB3]: 'https://subgraph.orb3.tech/subgraphs/name/flack/exchange-positions',
}
...
export const BLOCKS_CLIENT_WITH_CHAIN = {
  ...
  [ChainId.ORB3]: BLOCKS_CLIENT_ORB3,
}
...
export const V3_SUBGRAPH_URLS = {
  ...
  [ChainId.ORB3]: 'https://subgraph.orb3.tech/subgraphs/name/flack/exchange-v3',
