...
const walletsConfig = ({
  ...
  return [
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://hub.orb3.tech/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://orb3.tech/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://orb3.tech/get-started/wallet-guide`
