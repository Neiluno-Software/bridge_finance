import { BlockIcon, CheckmarkCircleIcon, Flex, BscScanIcon, RefreshIcon, EthChainIcon, EthScanIcon } from '@pancakeswap/uikit'
...
const TransactionRow: React.FC<React.PropsWithChildren<TransactionRowProps>> = ({ txn, chainId, type, onDismiss }) => {
  ...
  return (
    <TxnLink onClick={onClickTransaction}>
      ...
      <TxnIcon>
        {chainId === ChainId.ETHEREUM ? <EthScanIcon height="24px" color="primary" /> : <BscScanIcon width="24px" color="primary" />}
