...
import { orb3CollectionABI } from 'config/abi/orb3collection'
/**
...
export const useOrb3CollectionContract = (collectionAddress: Address) => {
  return useContract(collectionAddress, orb3CollectionABI)
}
