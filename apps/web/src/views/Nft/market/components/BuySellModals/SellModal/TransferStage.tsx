...
import { Button, ErrorIcon, EthChainIcon, Flex, Grid, Input, Text } from '@pancakeswap/uikit'
...
const TransferStage: React.FC<React.PropsWithChildren<TransferStageProps>> = ({
  ...
  const getErrorText = () => {
    if (isInvalidTransferAddress) {
      return t('That’s not a ETH Smart Chain wallet address.')
    }
    ...
    <>
      ...
      <GreyedOutContainer>
        ...
        <Input
          ...
          placeholder={t('Paste wallet address')}
