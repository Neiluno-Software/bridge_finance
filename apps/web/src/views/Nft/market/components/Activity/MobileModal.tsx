...
import { Box, Button, EthChainIcon, Flex, InjectedModalProps, Modal, OpenNewIcon, Text } from '@pancakeswap/uikit'
...
const MobileModal: React.FC<React.PropsWithChildren<MobileModalProps>> = ({
  ...
  const priceInUsd = ethPrice.multipliedBy(priceAsFloat)
