...
const Collectible = () => {
  ...
  return (
    <Page>
      <Heading as="h1" scale="xl" color="primary" data-test="nft-collections-title">
        {t('Collections')}
      </Heading>
                ...
                <thead>
                  <tr>
                    ...
                    <Th
                      textAlign="left"
                      style={{ cursor: 'pointer' }}
                      onClick={() => handleSort(SORT_FIELD.volumeETH)}
                    >
                      {t('Volume')}
              ...
              {sortedCollections.slice(ITEMS_PER_PAGE * (page - 1), page * ITEMS_PER_PAGE).map((collection) => {
                return (
                  <CollectionCardWithVolume
                    ...
                    volume={collection.totalVolumeETH ? parseFloat(collection.totalVolumeETH) : 0}
                  />
                )
              })}
            </Grid>
